...
INSERT  INTO LangDetail VALUES (2, N'AffliateUrlComment', N'このURLからユーザーが登録したユーザーのネットレベニュー');

INSERT  INTO LangDetail VALUES (1, N'AllStandardAffiliate', N'All Standard Affiliate');
INSERT  INTO LangDetail VALUES (2, N'AllStandardAffiliate', N'総アフィリエイト');

INSERT  INTO LangDetail VALUES (1, N'AllTopAgencyAffiliate', N'All Top Agency Affiliate');
INSERT  INTO LangDetail VALUES (2, N'AllTopAgencyAffiliate', N'総トップアフィリエイト');

INSERT  INTO LangDetail VALUES (1, N'CommissionAmount', N'Commission amount');
INSERT  INTO LangDetail VALUES (2, N'CommissionAmount', N'報酬量');

INSERT  INTO LangDetail VALUES (1, N'ConfirmPayment', N'Do you want to pay commision ?');
INSERT  INTO LangDetail VALUES (2, N'ConfirmPayment', N'報酬を支払いしますか？');
...
INSERT  INTO LangDetail VALUES (1, N'CurrencyPair', N'Currency Pair');
INSERT  INTO LangDetail VALUES (2, N'CurrencyPair', N'通貨ペア');
...
INSERT  INTO LangDetail VALUES (2, N'DeactivateLotteryGameConfirmation', N'宝くじゲームの無効を確認する');

INSERT  INTO LangDetail VALUES (1, N'DeactivateSuccessfully', N'Deactivate Successfully !');
INSERT  INTO LangDetail VALUES (2, N'DeactivateSuccessfully', N'無効化完了');
...
INSERT  INTO LangDetail VALUES (2, N'DirectIntroducedUsers', N'直売上');

INSERT  INTO LangDetail VALUES (1, N'DirectSale', N'Direct Sale');
INSERT  INTO LangDetail VALUES (2, N'DirectSale', N'直紹介者数');

INSERT  INTO LangDetail VALUES (1, N'ExistingCategory', N'Existing category, please use another.');
INSERT  INTO LangDetail VALUES (2, N'ExistingCategory', N'カテゴリは存在するので、別のカテゴリを使用してください。');

INSERT  INTO LangDetail VALUES (1, N'IsAutoPaymentEnable', N'Is auto payment enable');
INSERT  INTO LangDetail VALUES (2, N'IsAutoPaymentEnable', N'自動支払いが有効ですか？');

INSERT  INTO LangDetail VALUES (1, N'IsTier2TabVisible', N'Is tier2 tab visible');
INSERT  INTO LangDetail VALUES (2, N'IsTier2TabVisible', N'ティア2タブが表示される？');

INSERT  INTO LangDetail VALUES (1, N'IsTier3TabVisible', N'Is tier3 tab visible');
INSERT  INTO LangDetail VALUES (2, N'IsTier3TabVisible', N'ティア3タブが表示される？');

INSERT  INTO LangDetail VALUES (1, N'KindOfTier', N'Kind of tier');
INSERT  INTO LangDetail VALUES (2, N'KindOfTier', N'ティアのタイプ');

INSERT  INTO LangDetail VALUES (1, N'ListOfTopAgencyAffiliate', N'List of top agency affiliate');
INSERT  INTO LangDetail VALUES (2, N'ListOfTopAgencyAffiliate', N'トップアフィリエイトエージェンシーの一覧');
...
INSERT  INTO LangDetail VALUES (2, N'LotteryCategoryNameRequired', N'カテゴリの名を入力してください。');

INSERT  INTO LangDetail VALUES (1, N'LotteryCategoryRequired', N'Please select lottery category');
INSERT  INTO LangDetail VALUES (2, N'LotteryCategoryRequired', N'宝くじのカテゴリを選択してください');

INSERT  INTO LangDetail VALUES (1, N'NoData', N'No Data Available');
INSERT  INTO LangDetail VALUES (2, N'NoData', N'利用可能なデータがありません');

INSERT  INTO LangDetail VALUES (1, N'NumberOfTicket', N'Number Of Ticket');
INSERT  INTO LangDetail VALUES (2, N'NumberOfTicket', N'チケット数');
...
INSERT  INTO LangDetail VALUES (1, N'PageView', N'Page View');
INSERT  INTO LangDetail VALUES (2, N'PageView', N'ページビュー');

INSERT  INTO LangDetail VALUES (1, N'PaidSuccessfully', N'Paid successfully !');
INSERT  INTO LangDetail VALUES (2, N'PaidSuccessfully', N'支払い完成した！');

INSERT  INTO LangDetail VALUES (1, N'Pay', N'Pay');
INSERT  INTO LangDetail VALUES (2, N'Pay', N'支払い');

INSERT  INTO LangDetail VALUES (1, N'Payment', N'Payment');
INSERT  INTO LangDetail VALUES (2, N'Payment', N'お支払い');
...
INSERT  INTO LangDetail VALUES (2, N'Sales', N'販売');

INSERT  INTO LangDetail VALUES (1, N'StatisticChart', N'Statistic Chart');
INSERT  INTO LangDetail VALUES (2, N'StatisticChart', N'統計チャート');

INSERT  INTO LangDetail VALUES (1, N'Summary', N'Summary');
INSERT  INTO LangDetail VALUES (2, N'Summary', N'総合');

INSERT  INTO LangDetail VALUES (1, N'Tablet', N'Tablet');
INSERT  INTO LangDetail VALUES (2, N'Tablet', N'タブレット');

INSERT  INTO LangDetail VALUES (1, N'TimeRange', N'Time Range');
INSERT  INTO LangDetail VALUES (2, N'TimeRange', N'期間範囲');

INSERT  INTO LangDetail VALUES (1, N'TodayPlayers', N'Today Players');
INSERT  INTO LangDetail VALUES (2, N'TodayPlayers', N'今日のプレーヤー');

INSERT  INTO LangDetail VALUES (1, N'TopAgency', N'Top Agency');
INSERT  INTO LangDetail VALUES (2, N'TopAgency', N'トップエージェンシー');

INSERT  INTO LangDetail VALUES (1, N'TopAgencyAffiliate', N'Top Agency Affiliate');
INSERT  INTO LangDetail VALUES (2, N'TopAgencyAffiliate', N'トップエージェンシーのアフィリエイト');

INSERT  INTO LangDetail VALUES (1, N'TopAgencyAffiliateTiers', N'Top agency affiliate tiers');
INSERT  INTO LangDetail VALUES (2, N'TopAgencyAffiliateTiers', N'トップエージェンシーのティア');

INSERT  INTO LangDetail VALUES (1, N'TotalAffiliateSale', N'Total Affiliate Sale');
INSERT  INTO LangDetail VALUES (2, N'TotalAffiliateSale', N'総売上');

INSERT  INTO LangDetail VALUES (1, N'TotalCPLLost', N'Total CPL lost');
INSERT  INTO LangDetail VALUES (2, N'TotalCPLLost', N'総損失CPL');

INSERT  INTO LangDetail VALUES (1, N'TotalDirectIntroducedUsers', N'Total Direct Introduced Users');
INSERT  INTO LangDetail VALUES (2, N'TotalDirectIntroducedUsers', N'総直紹介者');

INSERT  INTO LangDetail VALUES (1, N'TotalIntroducedUsers', N'Total Introduced Users');
INSERT  INTO LangDetail VALUES (2, N'TotalIntroducedUsers', N'総紹介者');

INSERT  INTO LangDetail VALUES (1, N'TotalPlayers', N'Total Players');
INSERT  INTO LangDetail VALUES (2, N'TotalPlayers', N'総プレーヤー');

INSERT  INTO LangDetail VALUES (1, N'TotalPurchasePrice', N'Total purchase price');
INSERT  INTO LangDetail VALUES (2, N'TotalPurchasePrice', N'購入総額');

INSERT  INTO LangDetail VALUES (1, N'TotalRevenue', N'Total Revenue');
INSERT  INTO LangDetail VALUES (2, N'TotalRevenue', N'総収入');
