...
insert into LangMsgDetail values (1, N'AffiliateProgramPolicy', N'Sample affiliate policy');
insert into LangMsgDetail values (2, N'AffiliateProgramPolicy', N'Sample affiliate policy');
