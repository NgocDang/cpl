...
namespace CPL.Common.Enums
{
    public class CPLConstant
    {
        ...
        public struct Analytic
        {
            ...
            public static string LotteryViewId { get { if (Environment == EnumEnvironment.MAINNET) return "181871809"; else return "181852339"; } }
