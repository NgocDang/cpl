...
namespace CPL.WCF.Misc
{
    ...
    public class Status
    {
        ...
        public const int InvalidIxHashIdCode = UnAuthenticatedCode + 1;
        public const string InvalidIxHashIdText = "TxHashId is Invalid!";

        public const int ExceptionCode = InvalidIxHashIdCode + 1;
