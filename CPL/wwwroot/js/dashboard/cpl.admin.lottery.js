var AdminLottery = {
    ...
    init: function () {
        ...
        AdminLottery.bindAddPricePredictionSetting();
        AdminLottery.bindAddPricePredictionCategory();
        AdminLottery.bindDoAddPricePredictionCategory();

            $("#time1").unbind("keydown").keydown(function (e) { var thisk = e.keyCode || e.which; console.log(e.keyCode) });
            $("#date1").typeADate();
    },
