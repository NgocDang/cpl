var LotteryDetail = {
    init: function () {
        LotteryDetail.bindSpinTicketNumber();
        LotteryDetail.bindPurchaseTicket();
        LotteryDetail.bindDoPurchaseTicket();
        LotteryDetail.bindCancel();
    },
    ...
    bindDoPurchaseTicket: function () {
        $('#btn-confirm-purchase-lottery-ticket').click(function () {
            LotteryDetail.loadAjaxConfirmPurchaseTicket();
        });
