        ...
        $('#dt-history').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, full, meta) {
                        if (full.gameType == "LOTTERY")
                            return "<a href='/History/Lottery?createdDate=" + full.createdDate + "&lotteryId=" + full.gameId + "&sysUserId=" + sysUserId + "' target='_blank'  data-id='" + full.id + "' class='btn btn-sm btn-outline-secondary btn-view'>" + $("#view").val() +"</a>";
                        else if (full.gameType == "PRICE_PREDICTION")
