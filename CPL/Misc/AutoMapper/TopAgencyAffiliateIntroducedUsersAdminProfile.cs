...
{
    public class TopAgencyAffiliateIntroducedUsersAdminProfile : Profile
    {
        public TopAgencyAffiliateIntroducedUsersAdminProfile()
        {
            CreateMap<DataRow, TopAgencyAffiliateIntroducedUsersAdminViewModel>()
